...
class FullSleevesProductsViewAll extends StatefulWidget {
  FullSleevesProductsViewAll({
    Key? key,
  }) : super(key: key);

  @override
  _FullSleevesProductsViewAllState createState() =>
      _FullSleevesProductsViewAllState();
}

class _FullSleevesProductsViewAllState
    extends State<FullSleevesProductsViewAll> {
  ...
  Future<void> fetchProducts() async {
    ...
    final String query = '''
      {
        collection(id: "gid://shopify/Collection/163229761571") {
          products(first: 50) {
            edges {
              node {
                id
